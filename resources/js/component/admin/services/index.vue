            ...
            <section class="services section" id="services">
                ...
                <div class="modal main__modal " :class="{ show: showModal }">
                    <div class="modal__content">
                        ...
                        <form @submit.prevent="editMode.value">
                            <div>
                                <p>Service Name</p>
                            ...
                            <div class="model__footer">
                                ...
                                <button class="btn btn-secondary" @click="createService()" v-show="editMode == false">
                                    Save
                                </button>
                                <button class="btn btn-secondary" @click="updateService()" v-show="editMode == true">
                                    Update
                                </button>
                            </div>
                        </form>
