<template>
      ...
      <nav class="nav">
            <div class="nav_wrapper">
                ...
                <ul class="nav_list">
                    <li class="nav_item">
                        <router-link class="nav_link" to="/admin/home">
                    ...
                    <li class="nav_item">
                        <router-link class="nav_link " to="/admin/education">
                            <span class="nav_link--span--icon">
                                <i class="fas fa-home nav__link--icon"> </i>
                            </span>
                            <span class="nav_link--span--navname">
                    ...
                    <li class="nav_item">
                        <router-link  class="nav_link " to="/admin/project">
                            <span class="nav_link--span--icon">
                                <i class="fas fa-home nav__link--icon"> </i>
                            </span>
                            <span class="nav_link--span--navname">
                    ...
                    <li class="nav_item">
                        <router-link  class="nav_link " to="/admin/testimonial">
                            <span class="nav_link--span--icon">
                                <i class="fas fa-home nav__link--icon"> </i>
                            </span>
                            <span class="nav_link--span--navname">
                    ...
                    <!-- <li class="nav_item">
                        <router-link  class="nav_link " to="/admin/calculator">
                            <span class="nav_link--span--icon">
                                <i class="fas fa-home nav__link--icon"> </i>
                            </span>
                            <span class="nav_link--span--navname">
