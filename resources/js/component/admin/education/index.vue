            ...
            <section class="educations section" id="educations">
                <div class="skills_container">
                    ...
                    <div class="table">
                        ...
                        <!-- item 1 -->
                        <div class="education_table-items" v-for="item in education" :key="item.id" v-if="education.length > 0">
                    ...
                    <div class="modal__content">
                        ...
                        <form @submit.prevent="editMode ? updateEducation() : createEducation()">
                            <div>
                                ...
                                <small style="color: red;" v-if="errors.institution">{{ errors.institution }}</small>
                                <p>Period</p>
